<form class="px-4 py-3" method="post" action="bin/logear.php">
        <div class="form-group">
          <label for="exampleDropdownFormEmail1">Usuario</label>
          <input type="text" class="form-control" name="usuario" id="exampleDropdownFormEmail1" placeholder="Usuario">
        </div>
        <div class="form-group">
